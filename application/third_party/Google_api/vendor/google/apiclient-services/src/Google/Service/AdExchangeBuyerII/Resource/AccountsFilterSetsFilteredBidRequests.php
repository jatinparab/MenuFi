 ...
 *  </code>
 */
class Google_Service_AdExchangeBuyerII_Resource_AccountsFilterSetsFilteredBidRequests extends Google_Service_Resource
{
  /**
   ...
   * (filteredBidRequests.listAccountsFilterSetsFilteredBidRequests)
   *
   ...
   * to the accounts.filterSets.filteredBidRequests.list method.
   * @opt_param int pageSize Requested page size. The server may return fewer
   * results than requested. If unspecified, the server will pick an appropriate
   * default.
   * @return Google_Service_AdExchangeBuyerII_ListFilteredBidRequestsResponse
   */
  public function listAccountsFilterSetsFilteredBidRequests($accountId, $filterSetId, $optParams = array())
  {
