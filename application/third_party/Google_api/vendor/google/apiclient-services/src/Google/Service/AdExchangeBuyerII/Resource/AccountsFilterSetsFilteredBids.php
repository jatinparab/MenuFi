 ...
 *  </code>
 */
class Google_Service_AdExchangeBuyerII_Resource_AccountsFilterSetsFilteredBids extends Google_Service_Resource
{
  /**
   * List all reasons for which bids were filtered, with the number of bids
   * filtered for each reason. (filteredBids.listAccountsFilterSetsFilteredBids)
   *
   ...
   * accounts.filterSets.filteredBids.list method.
   * @opt_param int pageSize Requested page size. The server may return fewer
   * results than requested. If unspecified, the server will pick an appropriate
   * default.
   * @return Google_Service_AdExchangeBuyerII_ListFilteredBidsResponse
   */
  public function listAccountsFilterSetsFilteredBids($accountId, $filterSetId, $optParams = array())
  {
