 ...
 *  </code>
 */
class Google_Service_AdExchangeBuyerII_Resource_AccountsFilterSetsLosingBids extends Google_Service_Resource
{
  /**
   * List all reasons for which bids lost in the auction, with the number of bids
   * that lost for each reason. (losingBids.listAccountsFilterSetsLosingBids)
   *
   ...
   * accounts.filterSets.losingBids.list method.
   * @opt_param int pageSize Requested page size. The server may return fewer
   * results than requested. If unspecified, the server will pick an appropriate
   * default.
   * @return Google_Service_AdExchangeBuyerII_ListLosingBidsResponse
   */
  public function listAccountsFilterSetsLosingBids($accountId, $filterSetId, $optParams = array())
  {
