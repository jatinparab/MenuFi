...
class Google_Service_CloudMachineLearningEngine_GoogleIamV1Policy extends Google_Collection
{
  ...
  public $etag;
  public $iamOwned;
  protected $rulesType = 'Google_Service_CloudMachineLearningEngine_GoogleIamV1Rule';
  ...
  /**
   * @param Google_Service_CloudMachineLearningEngine_GoogleIamV1Rule
   */
  ...
  /**
   * @return Google_Service_CloudMachineLearningEngine_GoogleIamV1Rule
   */
