...
class Google_Service_CloudSourceRepositories_Rule extends Google_Collection
{
  ...
  /**
   * @param Google_Service_CloudSourceRepositories_Condition
   */
  ...
  /**
   * @return Google_Service_CloudSourceRepositories_Condition
   */
  ...
  /**
   * @param Google_Service_CloudSourceRepositories_LogConfig
   */
  ...
  /**
   * @return Google_Service_CloudSourceRepositories_LogConfig
   */
