...
class Google_Service_DLP_GooglePrivacyDlpV2beta1InspectResult extends Google_Collection
{
  protected $collection_key = 'findings';
  protected $findingsType = 'Google_Service_DLP_GooglePrivacyDlpV2beta1Finding';
  protected $findingsDataType = 'array';
  public $findingsTruncated;

  /**
   * @param Google_Service_DLP_GooglePrivacyDlpV2beta1Finding
   */
  ...
  /**
   * @return Google_Service_DLP_GooglePrivacyDlpV2beta1Finding
   */
