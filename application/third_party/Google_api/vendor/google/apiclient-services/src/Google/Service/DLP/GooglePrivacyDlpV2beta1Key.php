...
class Google_Service_DLP_GooglePrivacyDlpV2beta1Key extends Google_Collection
{
  protected $collection_key = 'path';
  protected $partitionIdType = 'Google_Service_DLP_GooglePrivacyDlpV2beta1PartitionId';
  protected $partitionIdDataType = '';
  protected $pathType = 'Google_Service_DLP_GooglePrivacyDlpV2beta1PathElement';
  ...
  /**
   * @param Google_Service_DLP_GooglePrivacyDlpV2beta1PathElement
   */
  ...
  /**
   * @return Google_Service_DLP_GooglePrivacyDlpV2beta1PathElement
   */
