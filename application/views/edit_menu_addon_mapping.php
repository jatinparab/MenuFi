...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Addons</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form method="post" action="<?php echo base_url(); ?>index.php/Admin/updateMenuAddonMapping" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="pwd">Addon Name: <?php echo $ing_details[0]['ing_name'];?></label>
