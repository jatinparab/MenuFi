...
?>
        ...
        <?php
			if(isset($_GET['error']))
			{
				echo "<div class='alert alert-danger' style='height: 45px; width: 100%; padding-left: 10px;    background: rgba(99, 88, 85, 0.33); color: #fff; border: none;
				border: 1px solid rgba(255, 255, 255, 0.22);' role='alert'><strong>".$_GET['error']."</strong> Try again with the correct OTP.</div>";
			}
		?>
    	<ul>

        	<li><a href="javascript: void(0);"><input type="text" pattern="[7-9]{1}[0-9]{9}" style="height: 45px; width: 100%; padding-left: 10px;    background: rgba(99, 88, 85, 0.33); color: #fff; border: none;
 border: 1px solid rgba(255, 255, 255, 0.22);" placeholder="Enter Your Mobile Number" name="mnumber" required></a></li>
			<li style="margin-top:10px;"><a href="#"><input type="checkbox" style="width:20px; float:left; outline:none;" required ><p>Terms and Condition Apply</p></a></li>

            <li><button class="btn btn-primary pull-right form-control" style="margin-left: 40px; width:100%; height:45px;">Submit</button></li>
