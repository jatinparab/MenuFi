                            ...
                            <div class="table-responsive">
                                <form method="post" action="stfadd">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="sal" class="form-control" name="salary" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="shift">Shift:</label>
                                        <input type="text" id="shift" class="form-control"  name="shift" required>
                                    </div>
                                  
                                    <div class="form-group">
                                        <label for="pwd">Chores:</label>
                                        <select name="chores" class="form-control">
