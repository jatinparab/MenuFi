...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit/Update Staff Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    if(isset($staff_details) && !empty($staff_details)){
                                        ...
                                        ?>
                                <form method="post" action="staffEdit1">
                                     <tr>
                                        <td><?php echo $i;?> <input type="hidden" name="id" value="<?php echo  $value->id;?>"></td>
                                        <td><?php echo $value->name;?> <input type="hidden" name="name" value="<?php echo  $value->name;?>"</td>

                                        <td><?php echo $value->salary; ?> <input type="hidden" name="salary" value="<?php echo  $value->salary;?>"></td>

                                        <td><?php echo $value->shifts; ?> <input type="hidden" name="shifts" value="<?php echo  $value->shifts;?>"></td>

                                        <td><?php echo $value->chores; ?> <input type="hidden" name="chores" value="<?php echo  $value->chores;?>"></td>
                                        <td>
