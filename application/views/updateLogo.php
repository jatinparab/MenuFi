...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add/Update Logo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row" id="outOfStock">
                <div class="col-lg-6">
                    <div class="alert alert-info">
                        <p>
                            <b>Note:</b> Logo Image Dimensions must be 284 x 174 px.
                        </p>
                    </div>
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form method="post" action="<?php echo base_url(); ?>index.php/Admin/updateLogo" enctype="multipart/form-data">
                                    
                                    <div class="form-group">
                                        <label for="pwd">Select Logo Image:</label>
